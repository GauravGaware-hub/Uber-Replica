  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-between'>
        <img className='h-24' src="https://tb-static.uber.com/prod/udam-assets/50b5e341-5426-42fd-acfe-037d63333de5.png" alt="" />
        <div className='text-right'>
          <h2 className='text-lg font-medium'>Gaurav</h2>
          <h4 className='text-xl font-semibold -mt-1 -mb-1'>MH14 AB 4533</h4>
